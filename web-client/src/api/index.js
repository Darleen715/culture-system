...
// 请求所有文创文章
export const getArticles = () => ajax(BASE_URL + '/api/article_list');

// 请求文创文章详细
export const getArticlesDetails = (params) => ajax(BASE_URL + '/api/articles_details' + params)

// 添加文创文章内容
export const addArticle = (title, content, likes, collects, tags, user_id) => ajax(BASE_URL + '/api/add_articles', { title, content, likes, collects, tags, user_id }, 'POST')


// 添加文创文章点赞数
export const addArticleLikes = (article_id, newLikes) => ajax(BASE_URL + '/api/articles/toggle-like', { article_id, newLikes }, 'POST')


// 删除单个文创文章
export const deleteArticle = (article_id, title) => ajax(BASE_URL + '/api/delete_article', { article_id, title }, 'POST');
