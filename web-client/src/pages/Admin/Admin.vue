    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky" style="background-color:#545c64">
            <a class="navbar-brand">
              <img src="./images/no_login.png" class="navbar-brand-img
              mx-auto" alt="..." style="width:70px;">
            </a>
            <el-menu default-active="2" @open="handleOpen" @close="handleClose" background-color="#545c64"
              text-color="#fff" active-text-color="#ffd04b" class="el-menu-vertical-demo">
              <el-menu-item index="1" @click="goTo('/admin/math')">
                <i class="el-icon-monitor"></i>
                <span>数据分析</span>
              </el-menu-item>
              <el-menu-item index="2" @click="goTo('/admin/admingoods')">
              ...
              <!-- <el-menu-item index="5" @click="goTo('/admin/comment')">
              ...
              <el-menu-item index="5" @click="goTo('/admin/adminarticles')">
