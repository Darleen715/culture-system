...
export const CART_GOODS_LIST = 'cart_goods_list'; // 收藏夹数据
export const CHANGE_GOODS_COUNT = 'change_goods_count'; // 改变收藏夹单个物品的数量
...
export const ARTICLES_LISTS = 'articles_lists';// 文章列表
export const ARTICLE_DETAILS = 'article_details';// 文章详细内容